  ...
  return (
    <div className="absolute_wrap">
        ...
        <div className="menu_col">
            ...
            <span className="menu_span2">Adjust the appearance of Facebook to reduce glare and give your eyes a break.</span>
        </div>
        </div>
        ...
        <div className="menu_col">
            ...
            <span className="menu_span2">Make your size smaller so more content can fit on the screen.</span>
        </div>
        </div>
