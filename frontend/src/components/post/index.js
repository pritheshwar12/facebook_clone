  ...
  return (
    <div className="post">
      ...
      <div className="to_right">
        <div className="comments_count">13</div>
        <div className="share_count">1</div>
      </div>
      </div>
      ...
      <div className="comments_wrap">
        ...
        <CreateComment user={user}/>
          ...
          {
            showMenu && (
      <PostMenu userId={user.id} postUserId={post.user._id} imageLength={post?.images?.length} setShowMenu={setShowMenu}/> 
