...
export default function EmojiPickerBackground({text,setText,user,type2,showPrev,setBackground,background}) {
  ...
  <div className={type2 ? "images_input":""}>
    ...
    {picker && (
      <div className={`comment_emoji_picker ${type2? "movepicker2": "rlmove"}`}>
        <Picker onEmojiClick={handleEmoji} height="380px" width="300px" />
      </div>
    )}
